...
#     - [х] для определения типа объекта, но не переменной
...
#     - [х] переменная type будет ссылаться на число 7

# Задание 12. Придумайте и запишите напротив названия переменным, в которых будут храниться:
#     hight = 194  - высота 
#     width = 50 - ширина
#     product_price = 125.35 - стоимость товара
#     age = 61 - возраст
#     error_message = "Ошибка загрузки" - сообщение об ошибке
#     success_message = "Ошибка загрузки" - сообщение об успехе
#     student_count = 45    - количество студентов
#     username = "Anatoliy" - имя пользователя
#     saverage_daily_temperature = 24.5 - Средняя температура за день
#     total_sales_for_month = 253000.52  - Общий объем продаж за месяц
#     video_views_count = 12000 - Количество просмотров видео
#     user_email "afzhuk@gmail.com" - Электронный адрес пользователя
#     freeavailable_seats = 10  - Количество доступных мест в аудитории
#     max_lift_capacity = 400 - Максимальная грузоподъемность лифта
#     task_completion_percentage = 85 - Процент выполнения задачи
#     user_rating = 4.3 - Оценка пользователя после обслуживания
#     total_wait_time = 25 - Суммарное время ожидания в очереди
#     document_page_count = 25 - Число страниц в документе
...
#   Вывод:
#   8
#   Ответ: print(2**3) или как вариант print(2**abs(-3))
...
#   Вывод:
#   3.142
#   Ответ: print(round(3.1415926535, 3)) # пояснение: математическую функцию math.pi у меня Python не определяет!!!!!!
...
#        num1 = float(input("Введите число 1: "))
#        num2 = float(input("Введите число 2: "))
#        mini_number = min(num1, num2)
#        print(f"Меньшее число: {mini_number}")
#
...
#        print(f"Большее числа>: {larger_number}")
#
...
#   Округленное число:
#   Ответ: 
#        fractional_number = float(input("Введите дробное число: "))
#        decimal_places = int(input("До скольких знаков нужно округлить: "))
#        rounded_number = round(fractional_number, decimal_places)
